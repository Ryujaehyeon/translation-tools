...
DEFAULT_OFFICIAL_KOREAN = Path(r"D:\Program Files (x86)\Steam\steamapps\common\Stellaris\localisation\korean")
DEFAULT_OFFICIAL_ENGLISH = Path(r"D:\Program Files (x86)\Steam\steamapps\common\Stellaris\localisation\english")
...
_COMMON_WORDS = {
    ...
    "on", "at", "by", "for", "with", "from", "into", "onto", "about",
    "and", "or", "but", "if", "as", "so", "yet", "nor",
    "it", "its", "this", "that", "these", "those", "they", "them",
    "their", "our", "your", "my", "his", "her", "we", "you", "he", "she",
    "not", "no", "all", "any", "each", "every", "more", "most", "other",
    "also", "than", "then", "when", "where", "which", "who", "how", "what",
    "new", "old", "get", "use", "used", "using", "make", "made", "take",
    "give", "given", "start", "end", "home", "base", "time", "way", "work",
    "level", "point", "points", "value", "size", "large", "small", "high",
    "low", "number", "total", "amount", "type", "set", "add", "added",
    "increase", "decrease", "reduce", "gain", "gains", "lose", "lost",
    "effect", "effects", "bonus", "penalty", "cost", "costs", "rate",
    "chance", "per", "max", "min", "unit", "units", "group", "name",
    "description", "note", "notes", "status", "state", "class", "list",
}
...
def main() -> int:
    ...
    TERM_KEY_PREFIXES = (
        "job_", "building_", "tech_", "trait_", "civic_", "origin_",
        "policy_", "tradition_", "ap_", "edict_", "decision_",
        "deposit_", "modifier_", "planet_class_", "pc_",
        "resource_", "pop_category_", "councilor_", "agenda_",
        "army_", "ship_", "weapon_", "component_", "federation_",
        "megastructure_", "starbase_", "district_", "sector_",
        "situation_", "crisis_", "ethic_", "authority_",
        "government_", "species_class_", "species_archetype_",
    )
