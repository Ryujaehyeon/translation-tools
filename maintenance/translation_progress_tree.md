...
| `archaeology_story_pack_4_4_1__3723865830` | 100.0% | 520 / 0 / 520 | 11 | 완료 |
...
| `expanded_stellaris_traditions_delta__3181487775` | 99.9% | 2,591 / 2 / 2,593 | 11 | 진행 중 (의심 2) |
| └─ `est_modifiers_key.csv` | 99.8% | 423 / 1 / 424 | 0 | 진행 중 (의심 1) |
| └─ `est_misc_key.csv` | 99.9% | 717 / 1 / 718 | 10 | 진행 중 (의심 1) |
...
| └─ `est_traditions_key.csv` | 100.0% | 960 / 0 / 960 | 1 | 완료 |
...
| `extra_ship_components_next__2648658105` | 100.0% | 5,550 / 0 / 5,550 | 1 | 완료 |
| └─ `esc_buildings_key.csv` | 100.0% | 130 / 0 / 130 | 0 | 완료 |
| └─ `esc_components_required_slots_key.csv` | 100.0% | 764 / 0 / 764 | 0 | 완료 |
| └─ `esc_components_utility_key.csv` | 100.0% | 774 / 0 / 774 | 0 | 완료 |
| └─ `esc_options_key.csv` | 100.0% | 197 / 0 / 197 | 0 | 완료 |
| └─ `esc_other_key.csv` | 100.0% | 354 / 0 / 354 | 1 | 완료 |
| └─ `esc_technologies_key.csv` | 100.0% | 1,041 / 0 / 1,041 | 0 | 완료 |
| └─ `esc_weapons_special_key.csv` | 100.0% | 1,248 / 0 / 1,248 | 0 | 완료 |
| └─ `esc_weapons_standard_key.csv` | 100.0% | 1,042 / 0 / 1,042 | 0 | 완료 |
...
| └─ `giga_gas_giant_hab_key.csv` | 99.0% | 104 / 1 / 105 | 2 | 진행 중 (의심 1) |
| └─ `giga_key.csv` | 99.4% | 10,812 / 70 / 10,882 | 21 | 진행 중 (의심 70) |
| └─ `giga_mega_events_key.csv` | 99.4% | 159 / 1 / 160 | 0 | 진행 중 (의심 1) |
| └─ `giga_qso_key.csv` | 99.5% | 211 / 1 / 212 | 2 | 진행 중 (의심 1) |
| └─ `frameworld_key.csv` | 99.6% | 778 / 3 / 781 | 3 | 진행 중 (의심 3) |
| └─ `giga_ehof_key.csv` | 99.7% | 1,943 / 6 / 1,949 | 4 | 진행 중 (의심 6) |
| └─ `giga_eawaf_key.csv` | 99.8% | 613 / 1 / 614 | 2 | 진행 중 (의심 1) |
| └─ `giga_blokkatnew_key.csv` | 99.9% | 711 / 1 / 712 | 0 | 진행 중 (의심 1) |
| └─ `giga_birch_key.csv` | 99.9% | 1,557 / 1 / 1,558 | 24 | 진행 중 (의심 1) |
...
| └─ `giga_alternate_mega_build_key.csv` | 100.0% | 383 / 0 / 383 | 5 | 완료 |
| └─ `giga_asteroid_industry_key.csv` | 100.0% | 181 / 0 / 181 | 0 | 완료 |
| └─ `giga_big_vat_key.csv` | 100.0% | 152 / 0 / 152 | 1 | 완료 |
| └─ `giga_catalyst_key.csv` | 100.0% | 33 / 0 / 33 | 1 | 완료 |
...
| └─ `giga_primitives_key.csv` | 100.0% | 74 / 0 / 74 | 0 | 완료 |
...
| `lillian_scarlet_remake__3757204211` | 100.0% | 29 / 0 / 29 | 0 | 완료 |
| └─ `0_key.csv` | 100.0% | 29 / 0 / 29 | 0 | 완료 |
...
| `nsc3__683230077` | 99.9% | 1,660 / 1 / 1,661 | 26 | 진행 중 (의심 1) |
| └─ `nsc_starbase_key.csv` | 99.3% | 139 / 1 / 140 | 0 | 진행 중 (의심 1) |
...
| └─ `nsc_ship_browser_key.csv` | 100.0% | 9 / 0 / 9 | 0 | 완료 |
| └─ `nsc_shipsections_key.csv` | 100.0% | 413 / 0 / 413 | 0 | 완료 |
...
| `starbase_extended_3_0__3250900527` | 100.0% | 174 / 0 / 174 | 1 | 완료 |
| └─ `starbase_extended_3.0_key.csv` | 100.0% | 174 / 0 / 174 | 1 | 완료 |
